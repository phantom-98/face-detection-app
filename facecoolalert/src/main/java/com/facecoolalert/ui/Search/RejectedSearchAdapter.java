...
public class RejectedSearchAdapter extends RecyclerView.Adapter<RejectedSearchAdapter.SearchResultViewHolder> {
//    private HashMap<String, String> items;
//    private List<String> listItems;

    private List<ImageSearchResult> results;

    public RejectedSearchAdapter()
    {
        results=new ArrayList<>();
    }


//    public RejectedSearchAdapter(HashMap<String, String> items) {
////        this.items = items;
...
//            notifyItemInserted(results.size()-1);
    ...
    public SearchResultViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_search_rejected_images, parent, false);
