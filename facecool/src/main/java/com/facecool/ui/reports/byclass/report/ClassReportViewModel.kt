...
import com.facecool.ui.reports.byclass.report.ReportData.Attendance
import com.facecool.ui.reports.byclass.report.ReportData.ClassName
import com.facecool.ui.reports.byclass.report.ReportData.Date
import com.facecool.ui.reports.byclass.report.ReportData.StudentName
import com.facecool.ui.reports.byclass.report.ReportData.StudentPhoto
                ...
                dates.forEachIndexed { indexRow, rowData ->
                    if (indexColumn > 0 && indexRow > 1) {
                        ...
                        if (!events.isEmpty()){
                            ...
                            value = d?.getReadableDate(pattern = "HH:mm")!!
