...
@AndroidEntryPoint
class YXLReportActivity : BaseActivity(), ReportTableAdapter.Listener{
    ...
    companion object {
        ...
        fun start(context: Context, classSelectionModel: ClassSelectionModel) {
            val starter = Intent(context, YXLReportActivity::class.java)
    ...
    private val viewModel: YXLReportViewModel by viewModels()
