...
public class BitmapUtils {
  ...
  public static Bitmap getBitmap(ByteBuffer data, FrameMetadata metadata) {
    ...
    Log.d("BitmapUtils", String.format("Frame (Width x Height) : (%d, %d)", metadata.getWidth(), metadata.getHeight()));
    Log.d("BitmapUtils", String.format("Frame Rotation : %d", metadata.getRotation()));
    ...
    try {
      ...
      Log.d("BitmapUtils", "getBitmap() Error: " + e.getMessage());
    }
    return null;
  }
...
//  }
  ...
  private static int getExifOrientationTag(ContentResolver resolver, Uri imageUri) {
    ...
    try (InputStream inputStream = resolver.openInputStream(imageUri)) {
      ...
      Log.d("BitmapUtils", "getExifOrientationTag() failed to open file to read rotation meta data: " + imageUri + "\nError : " + e.getMessage());
      return 0;
    }
  ...
  @Nullable
  public static Bitmap getPictureBitmap(String pathToPicture) throws IOException {
    Bitmap bitmap = BitmapFactory.decodeFile(pathToPicture);

    ExifInterface ei = new ExifInterface(pathToPicture);
